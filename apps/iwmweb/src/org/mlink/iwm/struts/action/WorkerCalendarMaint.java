 ...
 * Date: Oct 12, 2006
 */
public class WorkerCalendarMaint extends BaseAction {
    private static final Logger logger = Logger.getLogger(WorkerCalendarMaint.class);
    ...
    public ActionForward executeLogic(ActionMapping mapping,
        ...
        try {
            ...
            Person p = psf.get(Person.class, personId);
