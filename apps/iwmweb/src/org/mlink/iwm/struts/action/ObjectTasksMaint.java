 ...
 * Date: Oct 25, 2006
 */
public class ObjectTasksMaint  extends BaseAction {
    private static final Logger logger = Logger.getLogger(ObjectTasksMaint.class);
    ...
    public ActionForward executeLogic(ActionMapping mapping,
        ...
        try {
            ...
            context.add("hierarchy",TargetClassRef.getHierarchy(vo.getClassId()));
