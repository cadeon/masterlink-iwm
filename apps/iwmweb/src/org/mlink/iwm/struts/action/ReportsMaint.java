 ...
 * User: John Mirick
 */
public class ReportsMaint extends BaseAction {
    private static final Logger logger = Logger.getLogger(ReportsMaint.class);
    ...
    public ActionForward executeLogic(ActionMapping mapping,
        ...
        ReportsMaint.logger.debug("execute " + forward);
