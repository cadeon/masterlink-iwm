 ...
 */
package org.mlink.iwm.hibsession.client;
...
import org.mlink.iwm.hibentity.Customer;
import org.mlink.iwm.hibsession.CustomerRemote;
...
public class Client
{
   ...
   public static void main(String args[]) throws Exception
   {
      ...
      Customer oneMoreCustomer = customerBean.getCustomer(custId3);
      ...
      List<Customer> moreCustomers = customerBean.getCustomers("Jaikiran");
