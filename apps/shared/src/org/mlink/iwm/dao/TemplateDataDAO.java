 ...
 * Date: Oct 30, 2006
 */
public class TemplateDataDAO extends ListDAOTemplate {
    ...
    /*private static TemplateDataDAO ourInstance = new TemplateDataDAO();
    public static TemplateDataDAO getInstance() {return ourInstance;}
    private TemplateDataDAO() {}*/
    ...
    protected String getSql(SearchCriteria criteria) {
        ...
        sb.append("select ID,DATA_TYPE_ID,UOM_ID,DATA_VALUE,DATA_LABEL,IS_DISPLAY,IS_EDIT_IN_FIELD from  OBJECT_DATA_DEF WHERE OBJECT_DEF_ID  =?");
